...
export default function AllocationPlanning() {
  ...
  const [scrollToCapacity, setScrollToCapacity] = useState(false);
  ...
  useEffect(() => {
    ...
    if (sprint) setSelectedSprint(Number(sprint));
  ...
  // Scroll to capacity overview when needed
  useEffect(() => {
    if (scrollToCapacity) {
      setTimeout(() => {
