...
export default function ProjectManagement() {
  ...
  return (
    <div className="space-y-6">
        ...
        {canManageProjects && (
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 text-sm font-medium flex items-center gap-1"
            >
                  ...
                  <td className="py-3 px-4">
                    {canManageProjects ? (
                      <select
                        ...
                        className={`px-2 py-1 rounded text-xs border-0 cursor-pointer focus:ring-2 focus:ring-blue-300 ${
      ...
      <Modal isOpen={showImportModal} onClose={() => setShowImportModal(false)} title="Import Projects from Excel">
        <ImportProjects onComplete={() => setShowImportModal(false)} />
      </Modal>
    </div>
  );
}
